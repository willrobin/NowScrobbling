 ...
 *
 * Displays top artists for a given period.
 *
...
/**
 * Class TopArtistsShortcode
 *
 * Shows top artists.
 */
class TopArtistsShortcode extends AbstractShortcode {
     ...
     * @var string
     */
    protected string $tag = 'nowscr_lastfm_top_artists';
     ...
     * @var string
     */
    protected string $label = 'Last.fm Top Artists';
     ...
     * @var string
     */
    protected string $description = 'Displays top artists for a specified time period.';
    ...
    protected function fetchData( array $atts ): mixed {
        ...
        $response = $provider->fetchData( 'top_artists', [
            'limit'  => $atts['limit'],
            'period' => $atts['period'],
        ] );
    ...
    protected function getTemplateName(): string {
        return 'shortcodes/lastfm/top-artists';
    }
    ...
    protected function getEmptyMessage(): string {
        return __( 'No top artists found for this period.', 'nowscrobbling' );
    }
